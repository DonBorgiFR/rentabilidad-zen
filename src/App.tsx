              ...
              <div className="grid lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                   ...
                   <div className="glass-card p-8 bg-white/50 dark:bg-slate-900/50 border-blue-500/10 dark:border-blue-500/20 group hover:border-blue-500/40 transition-colors shadow-none">
                      ...
                      <div className="text-3xl font-black dark:text-white uppercase tracking-tighter">{results.paybackYears === Infinity ? 'âˆž' : results.paybackYears.toFixed(1)} <span className="text-sm font-light italic">aÃ±os</span></div>
                          ...
                          <div className="space-y-4 pt-8">
                             ...
                             <p className="text-sm text-slate-400 font-medium leading-relaxed">
                                <span className={cn(
                                  ...
                                  {inputs.rentaMensual/tenantScenario.income > 0.3 ? "âš ï¸  Exceso de Carga (>30%)" : "âœ… Alquiler Saludable"}
                                </span>
                             </p>
                          </div>
                       </div>
