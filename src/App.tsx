...
export default function App() {
  ...
  const [tenantScenario, setTenantScenario] = useState<{name: string, income: number}>({ name: 'Perfil EstíƒÂ¡ndar', income: 2500 });

  const tenantScenarios = [
    { name: 'Perfil EstíƒÂ¡ndar', income: 2500 },
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 selection:bg-emerald-500/30 transition-colors duration-500 font-sans pb-20">
        ...
        <div id="rental-app-content" className="bg-slate-50 dark:bg-slate-950 rounded-[3rem] p-4 sm:p-8 lg:p-12 mb-8 transition-colors duration-500">
          <header className="mb-16 text-center animate-fadeIn animation-delay-200">
            ...
            <h1 className="text-5xl lg:text-8xl font-black bg-clip-text text-transparent bg-gradient-to-b from-slate-900 via-emerald-900 to-slate-800 dark:from-white dark:via-emerald-400 dark:to-slate-300 tracking-tight leading-[0.9] uppercase pb-4">
              Control de <br/>
              <span className="text-emerald-600 dark:text-emerald-400 drop-shadow-sm">InversiíƒÂ³n</span>
            </h1>
          ...
          <main className="animate-fadeIn animation-delay-500">
            {activeTab === 'landlord' ? (
              <div className="grid lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-12 grid md:grid-cols-3 gap-8 mb-8">
                   <div className="glass-card p-10 flex flex-col justify-between group overflow-hidden relative border-emerald-500/10 dark:border-emerald-500/20 bg-emerald-600/5">
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm mt-4 font-medium leading-relaxed">Rentabilidad sobre el dinero real invertido de tu bolsillo cada aíƒÂ±o.</p>
                      </div>
                   ...
                   {/* Yield Flow Meter (Linear "Thermometer" style) */}
                    <div className="glass-card p-10 flex flex-col justify-between h-full bg-white/50 dark:bg-slate-900/50 border-emerald-500/5">
                        <div className="mb-4">
                            ...
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1 italic">DistribuciíƒÂ³n del Flujo de Caja Anual</p>
                        </div>
                        ...
                        <div className="pt-8 border-t border-slate-100 dark:border-slate-800 mt-4 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                               ...
                               <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Ratio de CapitalizaciíƒÂ³n</span>
                            </div>
                ...
                {/* MíƒÂ©tricas Avanzadas de GestiíƒÂ³n (Fase 4) */}
                <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                   ...
                   <div className="glass-card p-8 bg-white/50 dark:bg-slate-900/50 border-blue-500/10 dark:border-blue-500/20 group hover:border-blue-500/40 transition-colors shadow-none">
                      <p className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest mb-2">Punto de RecuperaciíƒÂ³n</p>
                      <div className="text-3xl font-black dark:text-white uppercase tracking-tighter">{results.paybackYears === Infinity ? 'í¢Ë†Å¾' : results.paybackYears.toFixed(1)} <span className="text-sm font-light italic">aíƒÂ±os</span></div>
                      <p className="text-[9px] text-slate-400 mt-2 font-bold uppercase tracking-tight">Tiempo recuperaciíƒÂ³n equity</p>
                   </div>
                   ...
                   <div className="glass-card p-8 bg-white/50 dark:bg-slate-900/50 border-purple-500/10 dark:border-purple-500/20 group hover:border-purple-500/40 transition-colors shadow-none">
                      ...
                      <p className="text-[9px] text-slate-400 mt-2 font-bold uppercase tracking-tight">DeducciíƒÂ³n Amort.+Intereses</p>
                   </div>
                </div>
                ...
                <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                      ...
                      >
                         <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            ...
                            <div className="sm:col-span-2 flex items-center justify-between p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-inner">
                               <div>
                                  <p className="font-black text-xs uppercase tracking-widest dark:text-white">í‚¿Zona Tensionada?</p>
                                  <p className="text-[10px] text-slate-400 mt-1">Afecta a príƒÂ³rrogas y topes de precios (Ley 2024)</p>
                               </div>
                               <button 
                      ...
                      >
                         <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-1">
                               ...
                               <p className="text-[9px] text-slate-400 px-4 italic font-medium tracking-tight">Ref: ~60í¢â€šÂ¬ - 120í¢â€šÂ¬ anual</p>
                            </div>
                            <div className="space-y-1">
                   ...
                   <div className="space-y-6">
                      <InputSection 
                        title="FinanciaciíƒÂ³n Escalonada" 
                      ...
                      >
                         <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            ...
                            <ZenInput label="InteríƒÂ©s (TIN %)" value={inputs.interes} onChange={(v) => setInputs({...inputs, interes: v})} step={0.1} />
                            <ZenInput label="Plazo (AíƒÂ±os)" value={inputs.plazoAnios} onChange={(v) => setInputs({...inputs, plazoAnios: v})} step={1} />
                            <ZenInput label="ComisiíƒÂ³n Apertura" value={inputs.comisionApertura} onChange={(v) => setInputs({...inputs, comisionApertura: v})} />
                         </div>
                      </InputSection>

                      <InputSection 
                        title="Fiscalidad (VersiíƒÂ³n 2024)" 
                        icon={<Scale size={20}/>}
                        bg="bg-rose-500/5"
                      ...
                      >
                         <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-4">
                               <label className="text-[11px] font-black uppercase tracking-widest text-slate-400">ReducciíƒÂ³n Ley Vivienda</label>
                               <select 
                               ...
                               >
                                  ...
                                  <option value={60}>60% - RehabilitaciíƒÂ³n</option>
                                  <option value={70}>70% - JíƒÂ³venes (18-35)</option>
                            ...
                            <div className="sm:col-span-2 pt-6 border-t border-slate-100 dark:border-slate-800">
                               ...
                               >
                                  {showAdvanced ? 'Cerrar Datos Catastrales' : 'Editar Datos Catastrales (CíƒÂ¡lculo AmortizaciíƒÂ³n)'}
                               </button>
                               {showAdvanced && (
                    ...
                    <div className="grid md:grid-cols-2 gap-16">
                       <div className="space-y-10">
                          <p className="text-xl text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                            Bajo la nueva Ley de Vivienda, los derechos del arrendatario estíƒÂ¡n blindados. Selecciona un escenario para auditar la viabilidad.
                          </p>
                          ...
                          <div className="space-y-6 pt-4">
                             ...
                             <CheckItem label="PríƒÂ³rrogas Extraordinarias: Hasta 3 aíƒÂ±os en zonas tensionadas por vulnerabilidad." />
                             <CheckItem label="Tope de Subida: Limitado al 3% anual en 2024 y al nuevo íƒÂ­ndice AEAT en 2025." />
                             <CheckItem label="GarantíƒÂ­as: El propietario no puede pedir míƒÂ¡s de 2 meses de fianza/garantíƒÂ­a adicional." />
                          </div>
                       </div>
      ...
      <div className="py-12 flex justify-center gap-6 animate-fadeIn">
          <a href="https://borjafelixrojas.odoo.com/" title="Compartir SimulaciíƒÂ³n" className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:text-emerald-500 hover:scale-110 transition-all shadow-xl shadow-slate-200 dark:shadow-none">
            <Share2 size={24} />
          </a>
      </div>
    </div>
    ...
    <div className="glass-card overflow-hidden bg-slate-900 text-white relative">
       ...
       <div className="p-10 sm:p-14 relative z-10">
          <div className="flex items-center gap-6 mb-12">
             ...
             <div>
                <h3 className="text-3xl font-black tracking-tighter uppercase italic">Estrategias <span className="text-emerald-500">OptimizaciíƒÂ³n</span></h3>
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-start">
             <ScenarioCard 
               ...
               impact="+22% Cash Flow"
               desc="Al bajar un 5% la renta en zona tensionada, activas la reducciíƒÂ³n del 90% en el IRPF (Ley 2024). El ahorro fiscal supera con creces la píƒÂ©rdida de ingreso bruto."
               result={formatEuro(results.cashFlowAnual * 1.22)}
             />
             <ScenarioCard 
               title="Inquilino Joven (18-35)"
               impact="+9% Neto"
               desc="Al alquilar a jíƒÂ³venes en zonas tensionadas, la reducciíƒÂ³n fiscal sube al 70%. Ideal para maximizar el retorno neto sin bajar el precio de mercado."
